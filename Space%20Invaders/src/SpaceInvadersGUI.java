...
public class SpaceInvadersGUI extends JPanel implements Runnable, KeyListener{
    ...
    public void run() {
        ...
        barrier = new Barrier(100, 450, 1, 1, Color.GREEN);
        barrier2 = new Barrier(450, 450, 1, 1, Color.GREEN);
        barrier3 = new Barrier(800, 450, 1, 1, Color.GREEN);
        bulletObj = new Bullet(450, 570, 5, 10, Color.WHITE);
